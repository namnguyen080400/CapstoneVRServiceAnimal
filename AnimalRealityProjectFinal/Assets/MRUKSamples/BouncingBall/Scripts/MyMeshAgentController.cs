...
namespace MRUtilityKitSample.NavMesh
{
    ...
    public class MyMeshAgentController : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            Debug.Log("Nam11 MyMeshAgentController OnEnable");
        ...
        void Update()
        {
            ...
            if (timer >= delayTimer)
            {
                ...
                if (!room)
                {
                    Debug.Log("Nam11 MyMeshAgentController Update no room");
                    return;
                }
                ...
                Debug.Log($"Nam11 MyMeshAgentController Update VisualizeTargetPosition = {VisualizeTargetPosition} agent.transform.position = {agent.transform.position} agent.speed = {agent.speed} newPos = {newPos}");   
